...
class PlayerRatingsHtmlCrawler extends React.Component {
  state = initialState;
  ...
  render() {
    return (
      <div>
        Select a Player Ratings file : <input type="file" onChange={(e) => this.handleFileSelect(e)} /><br /><br />
      </div>
    )
  }
...
export default PlayerRatingsHtmlCrawler;